            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="gpSurgery" placeholder="City Medical Center" defaultValue="City Medical Center" />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="gpAddress">GP Surgery Address</Label>
                  <Input id="gpAddress" placeholder="456 Health Ave" defaultValue="456 Health Ave" />
                </div>
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Require password to open the app</p>
                  </div>
                  <Switch />
                </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Receive medication time alerts</p>
                  </div>
                  <Switch defaultChecked />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label>Health News Updates</Label>
                    <p className="text-sm text-muted-foreground">Get updates on relevant health news</p>
                  </div>
                  <Switch defaultChecked />
                </div>
