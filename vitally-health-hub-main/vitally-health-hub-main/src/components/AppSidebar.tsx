...
const mainItems = [
  ...
  { title: "Care Plans", url: "/care-plans", icon: Activity },
...
const resourceItems = [
  { title: "Health News", url: "/health-news", icon: Newspaper },
];
      ...
      <SidebarContent>
        <div className="p-6 flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-sidebar-accent flex items-center justify-center">
            <Heart className="w-6 h-6 text-sidebar-foreground" fill="currentColor" />
          </div>
          {!isCollapsed && (
            <div>
              <h2 className="font-bold text-lg text-sidebar-foreground">Vitally</h2>
        ...
        <SidebarGroup>
          <SidebarGroupLabel className="text-sidebar-foreground/70">Resources</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
